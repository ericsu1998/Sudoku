...
def testVerifySolution():
    ...
    assert(not main.verifySolution(testRowDuplicates))
    ...
    assert(not main.verifySolution(testColDuplicates))
    ...
    assert(not main.verifySolution(testSquareDuplicates))
    ...
    assert(main.verifySolution(testCorrect))
    ...
    assert(main.verifySolution(testCorrect2))
    ...
    assert(main.verifySolution(testCorrect3))
